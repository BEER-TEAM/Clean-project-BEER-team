...
void tx_loop(OPERATING_MODE oper_mode)
{
	...
	while(1)
	{
		...
		//bme_get_data(&results);
		    ...
		    TLV humidityTLV = createTLV(humidity_tag, 1, &results.humidity);

		    TLV tlvs3[3] = {sequentialTLV,temperatureTLV,humidityTLV};
		    Message environmentkMsg = createMessage(NODE_ID, tlvs3, 3);
